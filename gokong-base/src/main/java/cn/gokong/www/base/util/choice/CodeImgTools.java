package cn.gokong.www.base.util.choice;
...
public class CodeImgTools {
    ...
    // 把图片和二维码合并
    public static String backBase64(String contUrl, String imgUrl) {
        try {
            // 替换字符
            ...
            // 把图片进行上传
            String str = FTPUtil.uploadStreamFile(DirectoryEnums.CODE_100010006, new FileInputStream(path));
            if (str != null) {
                // 删除图片
