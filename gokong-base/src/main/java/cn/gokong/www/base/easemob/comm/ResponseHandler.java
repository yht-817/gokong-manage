package cn.gokong.www.base.easemob.comm;
...
public class ResponseHandler {
    ...
    public Object handle(EasemobAPI easemobAPI) {
        ...
        try {
            ...
            if (e.getCode() >= 500) {
                logger.info("The dao connection failed and is being reconnected");
                result = retry(easemobAPI);
                if (result != null) {
                    return result;
                }
                System.out.println(e);
                logger.error("The dao may be faulty. Please try again later");
            }
            Gson gson = new Gson();
