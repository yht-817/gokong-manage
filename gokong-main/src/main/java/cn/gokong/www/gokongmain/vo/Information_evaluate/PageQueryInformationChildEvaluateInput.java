 ...
 * @Version 1.0
 **/
@ApiModel(value = "PageQueryInformationChildEvaluateInput", description = "分页查询资讯子评论入参")
public class PageQueryInformationChildEvaluateInput extends PageQueryBase {
